...
/// <summary>
/// Transports player to the seventh floor.
/// </summary>
public class StairsScriptFloor6 : MonoBehaviour
{
    GSMScript gsmScript;
    ...
    /// <summary>
    /// If player enters trigger, changes to level 7.
    /// </summary>
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            gsmScript.sceneChange(CodeLibrary.floor7Scene);
        }
    }
}
